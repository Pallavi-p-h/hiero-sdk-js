...
describe("ProxyStaker", () => {
    ...
    describe("_fromProtobuf", () => {
        it("deserializes a protobuf object with a positive amount", () => {
            ...
            expect(staker.accountId.num.toNumber()).toBe(5);
            expect(staker.amount.toTinybars().toNumber()).toBe(1000);
        });
    ...
    describe("_toProtobuf", () => {
        it("serializes to a protobuf object", () => {
            ...
            expect(proto.accountID).toEqual(accountId._toProtobuf());
        ...
        it("round-trips through _fromProtobuf and _toProtobuf", () => {
            ...
            expect(roundTripped.accountID).toEqual(staker.accountId._toProtobuf());
            expect(roundTripped.amount.toNumber()).toBe(original.amount);
        });
